...
def open_browser():
    # Yeh function aapke default browser me link open karega
    webbrowser.open_new('http://127.0.0.1:5000/')

if __name__ == '__main__':
    # Server start hone ke 1.5 seconds baad browser open karne ka timer
    Timer(1.5, open_browser).start()
    
    # Dhyan dein: yahan humne debug=False kar diya hai. 
    # Agar debug=True rahega, toh Flask server do baar restart hota hai aur browser 2 tabs me open ho jayega.
